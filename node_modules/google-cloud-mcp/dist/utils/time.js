...
export function parseRelativeTime(timeString) {
    ...
    if (!match) {
        throw new GcpMcpError(`Invalid time format: ${timeString}. Use format like "30s", "5m", "2h", "1d", or "1w".`, 'INVALID_ARGUMENT', 400);
    }
    ...
    switch (unit) {
        ...
        default:
            throw new GcpMcpError(`Invalid time unit: ${unit}. Use s, m, h, d, or w.`, 'INVALID_ARGUMENT', 400);
    }
}
