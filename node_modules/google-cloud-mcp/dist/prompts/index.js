 ...
 * @param server The MCP server instance
 */
function registerLogAnalysisPrompts(server) {
    // Analyse errors in logs
    server.prompt('analyse-errors', {
 ...
 * @param server The MCP server instance
 */
function registerMonitoringPrompts(server) {
    // Performance overview
    server.prompt('performance-overview', {
        timeframe: z.string().describe('Time range to analyse (e.g., "1h", "24h", "7d")'),
        service: z.string().optional().describe('Filter by service name')
    }, async (args, _extra) => {
    ...
    // Alert investigation
    server.prompt('alert-investigation', {
 ...
 * @param server The MCP server instance
 */
function registerSpannerPrompts(server) {
    // Schema explanation
    server.prompt('schema-explanation', {
    ...
    // Query optimization
    server.prompt('query-optimization', {
        instanceId: z.string().describe('Spanner instance ID'),
        databaseId: z.string().describe('Spanner database ID'),
    ...
    // Data exploration
    server.prompt('data-exploration', {
        instanceId: z.string().describe('Spanner instance ID'),
        databaseId: z.string().describe('Spanner database ID'),
