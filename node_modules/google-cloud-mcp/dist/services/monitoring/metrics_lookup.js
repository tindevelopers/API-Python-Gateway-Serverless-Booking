...
(function (MetricCategory) {
    MetricCategory["GCP"] = "gcp";
    MetricCategory["Kubernetes"] = "kubernetes";
    MetricCategory["Istio"] = "istio";
...
export class MetricsLookup {
     ...
     */
    async parseMetricsFile(category) {
     ...
     */
    findMetrics(query, category, limit = 5) {
        if (!this.initialized) {
     ...
     */
    calculateRelevanceScore(metric, terms, fullQuery) {
        let score = 0;
...
//# sourceMappingURL=metrics_lookup.js.map