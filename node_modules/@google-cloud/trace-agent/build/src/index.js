...
function initConfig(userConfig) {
    ...
    return {
        ...
        logLevel: (0, util_1.lastOf)(mergedConfig.logLevel, Number(process.env.GCLOUD_TRACE_LOGLEVEL)),
        clsConfig: {
            [util_1.FORCE_NEW]: forceNew,
        ...
        writerConfig: {
            ...
            serviceContext: {
                service: (0, util_1.lastOf)(mergedConfig.serviceContext.service, process.env.GAE_MODULE_NAME, process.env.GAE_SERVICE),
                version: (0, util_1.lastOf)(mergedConfig.serviceContext.version, process.env.GAE_MODULE_VERSION, process.env.GAE_VERSION),
                minorVersion: (0, util_1.lastOf)(mergedConfig.serviceContext.minorVersion, process.env.GAE_MINOR_VERSION),
            },
            /**
            ...
            authOptions: Object.assign({}, mergedConfig, {
                projectId: (0, util_1.lastOf)(mergedConfig.projectId, process.env.GCLOUD_PROJECT),
            }),
        },
        pluginLoaderConfig: {
            [util_1.FORCE_NEW]: forceNew,
